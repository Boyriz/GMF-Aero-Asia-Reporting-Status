    ...
    <div>
        ...
        <section class="section-details-content">
          ...
          <div class="row" id="textColor">
            <h1>Time Controlled Database</h1>
          </div>
        </section>
          ...
          <div class="card card-details">
            <div class="select">
              <select class="form-control" id="locale">
                <option value="Time Controlled" selected>Time Controlled</option>
                <option value="Non-Time Controlled">Non-Time Controlled</option>
              </select>
            </div>
            <div id="toolbar">
              <router-link 
            ...
            <div id="buttonBar">
                ...
                <router-link 
                    to="/appComparisonTC"
                    type="button"
                    class="btn btn-outline-warning">COMPARE
                </router-link> 
            </div>
            <div>
              <b-row>
...
export default {
  ...
  components: {
      ...
      //   },
            ...
            //       const val = value.toLowerCase();
            //       const functionalLocation = i.functionalLocation && i.functionalLocation.toLowerCase();
            //       const partNumber = i.partNumber && i.partNumber.toLowerCase();
            //       const serialNumber = i.serialNumber && i.serialNumber.toLowerCase();
            //       const description = i.description && i.description.toLowerCase();
            ...
            //       if (
            //         val &&
            //         (functionalLocation.indexOf(val) !== -1 ||
            //           partNumber.indexOf(val) !== -1 ||
            //           serialNumber.indexOf(val) !== -1 ||
            //           description.indexOf(val) !== -1 ||
            //           mpNumber.indexOf(val) !== -1 ||
            //           task.indexOf(val) !== -1 ||
            //           installDate.indexOf(val) !== -1 ||
            //           tsnHrs.indexOf(val) !== -1 ||
            //           tsnCyc.indexOf(val) !== -1 ||
            //           intervalHrs.indexOf(val) !== -1 ||
            //           intervalCyc.indexOf(val) !== -1 ||
            //           intervalDays.indexOf(val) !== -1 ||
            //           tslaHrs.indexOf(val) !== -1 ||
            //           tslaCyc.indexOf(val) !== -1 ||
            //           tslaDays.indexOf(val) !== -1 ||
            //           lifeRemaining.indexOf(val) !== -1
            //         )
            //       ) {
            //         return true;
            //       }
